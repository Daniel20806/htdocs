...
(1, '天線寶寶', '2024-06-13 11:21:13', '很好'),
(1, '天線寶寶', '2024-06-13 11:21:27', '很爛'),
(1, '天線寶寶', '2024-06-13 11:21:43', '普通'),
(1, '天線寶寶', '2024-06-13 11:21:57', '還不錯'),
(1, '海綿寶寶', '2024-06-13 19:32:27', 'yyds, 童年的神'),
(1, '測試', '2024-06-13 23:57:28', '你好'),
(1, '測試', '2024-06-14 00:40:39', '測試'),
(1, '測試', '2024-06-14 01:13:28', '測試123'),
(1, '測試', '2024-06-14 11:43:46', '主角真帥'),
(1, '測試', '2024-06-14 13:18:58', '測試'),
(1, '測試', '2024-06-14 13:20:09', '你好'),
(1, '測試', '2024-06-14 18:29:24', '測試評論人'),
(2, '測試', '2024-06-14 18:52:03', '我測試'),
...
('天線寶寶', 3.6, 220, '2014-03-11 00:00:00', '《天線寶寶》有兩個元素：一個是「幻想園地」、一個是「真實紀錄」。「幻想園地」是指《天線寶寶》的主要場景「神奇島」(香港譯名為天線得得園)，島上有許多幻想奇觀，讓孩子有創造力、想像力；四個天線寶寶在神奇島上玩樂，彼此之間有良好的關係，沒有暴力，雖然很多事情都不懂，但是很喜歡學習。天線寶寶們是科技的產物，是幻想的人物，不等同於人類，所以不一定要有父母、兄弟姊妹等人類關係，坐下時會發出「叭」的聲音。 ', '普遍級', 'image\\166262117594.jpg'),
...
('測試', 4.22222, 40, '2024-06-13 20:18:00', 'awfaf', '限制級', 'image/IMG_4354.jpg');
...
('測試', '鑽石廳', '11-11', '01:03:00'),
('測試', '鑽石廳', '12-00', '01:03:00');
